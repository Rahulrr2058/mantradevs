...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "clinicsathi-case-study",
    title: "Case Study: Scaling ClinicSathi — Modernizing Healthcare Management in Nepal",
    seoTitle: "ClinicSathi Case Study: Modernizing Healthcare in Nepal | Mantra Devs",
    metaDescription: "Learn how Mantra Devs (MantraDevs / Mantrs Devs) engineered ClinicSathi, a high-performance Healthcare SaaS solving patient scheduling, EMR, and billing challenges in Nepal.",
    category: "Case Study",
    publishDate: "May 18, 2025",
    updatedDate: "May 20, 2025",
    readingTime: 9,
    featuredImage: "/work/clinicsathi.png",
    featuredImageAlt: "ClinicSathi dashboard showing patient analytics and queue management",
    color: "#6366f1",
    excerpt: "How we built a reliable, secure, and intuitive clinic management platform (ClinicSathi) to digitalize healthcare operations in Nepal.",
    tags: ["ClinicSathi", "Healthcare SaaS", "Next.js", "Supabase", "React", "IT Company Nepal", "Mantra Devs"],
    sections: [
      {
        id: "the-healthcare-challenge",
        heading: "The Healthcare Challenge: Operational Chaos in Clinics",
        level: 2,
        content: "Before ClinicSathi, most medical clinics in Nepal relied on paper registers to book appointments, track medical histories, and manage bills. This manual system caused massive queue delays, lost patient files, and administrative errors. As a premium IT company in Nepal, Mantra Devs (often searched as MantraDevs or Mantrs Devs) was approached to build a modern software solution to streamline these operations.",
      },
      {
        id: "engineering-the-solution",
        heading: "Engineering the Solution: ClinicSathi's Tech Stack",
        level: 2,
        content: "To build a robust, secure, and fast platform, our software development team selected a cutting-edge tech stack. ClinicSathi is built with Next.js for a performant frontend and Supabase for a reliable PostgreSQL database, real-time sync, and secure authentication. This stack allows for instant data updates, which is crucial when clinic receptionists and doctors are updating patient statuses simultaneously.",
        bullets: [
          "Next.js with custom React state management for seamless patient queue views",
          "Supabase PostgreSQL for transactional safety and complex medical data relationships",
          "Real-time subscriptions to sync appointment queues between receptionist desk and doctor cabins",
          "Secure document storage for digitized X-rays and medical prescriptions",
        ],
      },
      {
        id: "key-features",
        heading: "Key Features: Patient Queues & WhatsApp Reminders",
        level: 2,
        content: "We didn't just build a database; we built tools that directly improve daily operations. Two core features define ClinicSathi: real-time patient queue management and automated callback/appointment reminders. The reminder system uses a background WhatsApp cron worker running on our servers, ensuring patients never miss their appointments and clinics maintain a high booking rate.",
        image: { src: "/work/clinicsathi.png", alt: "ClinicSathi dashboard interface overview", caption: "ClinicSathi simplifies outpatient department (OPD) management with a clean, drag-and-drop queue system." },
      },
      {
        id: "privacy-and-compliance",
        heading: "Data Security & Patient Privacy",
        level: 2,
        content: "Medical data is highly sensitive. We engineered ClinicSathi with end-to-end encryption, strict role-based access control (RBAC), and detailed audit logs. Doctors only see their own patients' records, and receptionist access is restricted to billing and scheduling, guaranteeing complete patient confidentiality.",
      },
    ],
  },
  {
    slug: "retrokit-ecommerce",
    title: "Case Study: Engineering Retrokit Nepal — Custom E-Commerce for Classic Cars",
    seoTitle: "Retrokit Nepal Case Study: High-Performance Automotive E-Commerce | Mantra Devs",
    metaDescription: "Discover how Mantra Devs (MantraDevs / Mantrs Devs) built Retrokit Nepal, a modern, highly interactive, and lightning-fast storefront for classic automotive restoration kits.",
    category: "E-Commerce",
    publishDate: "May 22, 2025",
    updatedDate: "May 24, 2025",
    readingTime: 8,
    featuredImage: "/work/retrokit.png",
    featuredImageAlt: "Retrokit Nepal storefront displaying custom car grills and vintage lights",
    color: "#f59e0b",
    excerpt: "Unpacking the technology behind Retrokit Nepal, a high-performance storefront designed for classic automotive restoration kits.",
    tags: ["Retrokit Nepal", "E-Commerce", "Next.js", "Tailwind CSS", "Web Performance", "Mantra Devs", "Mantrs Devs"],
    sections: [
      {
        id: "the-ecommerce-landscape",
        heading: "The E-Commerce Challenge: Showcasing Classic Restoration",
        level: 2,
        content: "Retrokit Nepal specializes in bringing vintage cars and classic bikes back to life. Standard e-commerce platforms like Shopify or WooCommerce fell short when handling the complex cataloging and interactive part-matching requirements of restoration enthusiasts. Mantra Devs (Mantrs Devs / MantraDevs) stepped in to engineer a custom e-commerce portal that delivers premium aesthetics and frictionless shopping.",
      },
      {
        id: "performance-optimization",
        heading: "Performance as a Revenue Driver",
        level: 2,
        content: "In e-commerce, speed translates directly to sales. We leveraged Next.js's static export and incremental static regeneration to build Retrokit. Every page loads in under 400 milliseconds. We optimized the Core Web Vitals to achieve near-perfect performance scores, which also gave Retrokit a massive SEO advantage, ranking them at the top of Google searches for automotive restoration in Nepal.",
        bullets: [
          "Fully static page generation (SSG) for instant navigation",
          "Image optimization converting raw parts photos into next-gen WebP/AVIF formats",
          "Optimized bundle size with code splitting to reduce initial JavaScript load",
          "Global CDN caching for sub-millisecond Time to First Byte (TTFB)",
        ],
      },
      {
        id: "interactive-ui",
        heading: "Crafting an Interactive Part Finder",
        level: 2,
        content: "Finding the exact headlamp or engine gasket for a 1974 Land Cruiser can be daunting. We built a custom interactive parts finder that lets customers filter by make, model, production year, and engine type in real time. The interface feels completely premium, featuring smooth animations and high-resolution visual previews.",
        image: { src: "/work/retrokit.png", alt: "Retrokit Nepal parts catalog search", caption: "Interactive filters make finding rare automotive parts simple and intuitive." },
      },
    ],
  },
  {
    slug: "nepal-it-landscape",
    title: "Why Mantra Devs is Setting the Benchmark for the Best IT Company in Nepal",
    seoTitle: "Best IT Company in Nepal: Redefining Tech Standards | Mantra Devs",
    metaDescription: "Looking for the best IT company or software development studio in Nepal? Discover how Mantra Devs (MantraDevs / Mantrs Devs) is setting new benchmarks in engineering.",
    category: "Industry Insights",
    publishDate: "May 25, 2025",
    updatedDate: "May 26, 2025",
    readingTime: 10,
    featuredImage: "/blog/custom.png",
    featuredImageAlt: "Mantra Devs software engineers collaborating in the studio",
    color: "#10b981",
    excerpt: "The IT landscape in Nepal is evolving rapidly. Here is how Mantra Devs is pushing the boundaries of software engineering, custom products, and design.",
    tags: ["Best IT Company", "IT Company Nepal", "Software Development", "Nepal Tech", "Mantra Devs", "Mantrs Devs"],
    sections: [
      {
        id: "the-nepalese-tech-boom",
        heading: "The Nepalese Tech Boom: Moving Beyond Basic Outsourcing",
        level: 2,
        content: "For years, many IT companies in Nepal operated solely as outsourcing hubs, focusing on high-volume, low-cost maintenance work. However, the modern digital landscape demands premium product engineering. Clients want software that is fast, beautiful, and secure. Mantra Devs (also searched as MantraDevs or Mantrs Devs) was founded to fill this gap, building high-end custom software that rivals top Silicon Valley agencies.",
      },
      {
        id: "what-defines-the-best-it-company",
        heading: "What Makes Mantra Devs the Best IT Company?",
        level: 2,
        content: "To be recognized as the best IT company in Nepal, we focus on three core principles: design-first engineering, modern tech stacks, and deep integration of artificial intelligence. We don't build generic websites; we create custom SaaS solutions like ClinicSathi and interactive e-commerce portals like Retrokit Nepal. Our team engineers for longevity, accessibility, and stellar user experiences.",
        bullets: [
          "Design-First Philosophy: Our products look premium and feel incredibly polished, using custom animations and curated color palettes.",
          "Modern Stacks: We use React, Next.js, NestJS, and cloud-native serverless hosting rather than outdated legacy frameworks.",
          "AI & Automation: We integrate large language models (LLMs) and semantic vector searches directly into product workflows.",
          "Local Impact: We actively train local talent, providing industry-aligned IT training with real-life projects.",
        ],
      },
      {
        id: "our-approach-to-it-work",
        heading: "Our Approach to Client Projects",
        level: 2,
        content: "Our development workflow is collaborative and transparent. We work with clients to define product goals, establish clean API contracts, and set up continuous integration/deployment (CI/CD) pipelines. This ensures that every deployment is automated and zero-downtime, keeping your software online 24/7.",
        image: { src: "/blog/custom.png", alt: "Mantra Devs software engineers collaborating in the studio", caption: "At Mantra Devs, we combine design and engineering to build state-of-the-art software systems." },
      },
      {
        id: "building-the-future",
        heading: "Building the Future of Tech in Nepal",
        level: 2,
        content: "Whether you are a local startup looking to digitalize your operations or an international business needing a high-performance software agency, Mantra Devs is your premier partner. We are committed to showing that world-class software engineering can be crafted right here in Nepal.",
      },
    ],
  },
];
